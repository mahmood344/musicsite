<template>
  <v-card
    flat
    class="w-100 h-full mx-auto mt-4"
    max-width="1800"
      ...
      >
        ...
        >
          ...
          >
            <v-card-text
              v-show="true"
              class="mx-4 rounded-xl text-justify"
              style="background: transparent"
            >
              <v-expand-transition v-show="true">
...
const tracks = [
  {
    ...
    timedLyrics: [
      ...
      {
        time: 44,
        text: "غمی که از تو رو قلب من هست یه زخمیه که تا ابد دوا نداره",
      },
      ...
      {
        time: 134,
        text: "برم کدوم دردو پیش کی ببارم بگو کجای دلم تو رو بزارم",
      },
  ...
  },
  {
    ...
    timedLyrics: [
      ...
      {
        time: 187,
        text: "تو از قلب من گذر می کنی همان لحظه باران به تو میرسد",
      },
